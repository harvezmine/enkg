...
export function Procon() {
  return (
    <section id="procon" className="relative isolate overflow-hidden bg-navy-950 px-5 pt-24 pb-28 text-cream-100 sm:px-8 lg:pt-32 lg:pb-36">
      ...
      />
      <div aria-hidden="true" className="animate-breathe pointer-events-none absolute -top-40 right-[-8%] -z-10 h-[32rem] w-[32rem] rounded-full bg-sun-500/15 blur-3xl" />
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-end lg:gap-12">
          <Reveal className="lg:col-span-7">
            ...
            <h2 className="text-display mt-5 font-bold">
              Bertumbuh di pekerjaan,{" "}
              <span className="font-serif font-normal tracking-normal text-sun-400 italic">keuangan,</span> dan
              kepemimpinan.
            </h2>
          </Reveal>
              ...
              <Reveal as="li" key={event.id} delay={index * 90} className={featured ? "lg:row-span-2" : ""}>
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 text-sm">
                    ...
                    <span className={`inline-flex items-center gap-1.5 ${featured ? "text-ink/70" : "text-cream-100/60"}`}>
        ...
        <Reveal className="mt-8 flex flex-col gap-5 rounded-3xl bg-white/4 p-6 ring-1 ring-white/10 sm:flex-row sm:items-center sm:justify-between sm:p-7">
          <p className="max-w-xl text-cream-100/75">
            Jadwal lengkap dan pendaftaran ProCon segera tersedia di situs {procon.partnerSite.name}. Sementara itu, tanya
            jadwal terdekat lewat WhatsApp.
          </p>
          <a
